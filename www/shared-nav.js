...
export class AppNavigation {
    constructor(config) {
        ...
        this.hubApps = [
            ...
            { name: 'Route', url: '/routetrackr', icon: 'fa-map-location-dot', color: 'bg-lime-600' },
            { name: 'Food', url: '/foodtrackr', icon: 'fa-utensils', color: 'bg-orange-600' },
            { name: 'Recipe', url: '/recipemanagr', icon: 'fa-book-open', color: 'bg-teal-600' },
            { name: 'Task', url: '/tasktrackr', icon: 'fa-check-double', color: 'bg-blue-600' },
            { name: 'Video', url: '/vidtrackr', icon: 'fa-ticket', color: 'bg-red-600' },
            { name: 'Book', url: '/booktrackr', icon: 'fa-book-open', color: 'bg-amber-500' },
            { name: 'Health', url: '/healthmanagr', icon: 'fa-notes-medical', color: 'bg-pink-600' },
            { name: 'Podcast', url: '/podtrackr', icon: 'fa-podcast', color: 'bg-purple-600' },
            { name: 'Logger', url: '/log', icon: 'fa-pen-to-square', color: 'bg-green-600' },
            { name: 'Journal', url: '/journaltrackr', icon: 'fa-newspaper', color: 'bg-purple-500' },
            ...
            { name: 'Pet', url: '/petmanagr', icon: 'fa-paw', color: 'bg-indigo-600' },
            { name: 'Plant', url: '/planttrackr', icon: 'fa-leaf', color: 'bg-green-600' },
            { name: 'Money', url: '/moneymanagr', icon: 'fa-piggy-bank', color: 'bg-blue-500' },
        ];
...
            const handleClearAll = async (e) => {
    ...
    switchTab(tabId) {
        ...
        const activeClassDesktop = `text-${this.themeColor}-700 dark:text-${this.themeColor}-400 bg-${this.themeColor}-100 dark:bg-gray-900 shadow-sm ring-1 ring-${this.themeColor}-300 dark:ring-gray-700`;
