...
},
{
    ...
    changes: [
                ...
                "In MoneyManagr: Implemented a double-entry repayment system in the Inbox Categorization modal by adding a 'Bank (If Repayment)' dropdown to clear a person's debt while simultaneously updating the linked bank balance."
    ]
},
    {
...
changes: [
    ...
    date: "2026-04-15",
    changes: [
        "In all: Further service worker & CSS bug fixes/adjustments.",
    ]
    },
    {
    ...
    date: "2026-04-15",
    changes: [
        "In all: Improved offline caching & service worker deployment.",
    ]
    },
    {
    version: "v14.30.7-alpha",
    date: "2026-04-14",
    changes: [
        "In Hub: Bug fix on mobile devices - 5.",
    ]
    },
    {
    version: "v14.30.6-alpha",
    date: "2026-04-14",
    changes: [
        "In Loggr: Bug fix on mobile devices - 4.",
    ]
    },
    {
    version: "v14.30.5-alpha",
    date: "2026-04-14",
    changes: [
        "In Loggr: Bug fix on mobile devices - 3.",
    ]
    },
    {
    version: "v14.30.4-alpha",
    date: "2026-04-14",
    changes: [
        "In Loggr: Bug fix on mobile devices - 2.",
    ]
    },
    {
    version: "v14.30.3-alpha",
    date: "2026-04-14",
    changes: [
        "In Loggr: Bug fix on mobile devices.",
    ]
    },
    {
    version: "v14.30.2-alpha",
    date: "2026-04-14",
    changes: [
    ...
    {
    version: "v14.30.0-alpha",
    date: "2026-04-14",
    changes: [
        "In Hub: Improved the login screen by adding a progress spinner to authentication buttons, locking input fields during login attempts, and enabling the 'Enter' key to submit credentials.",
    ]
    },
    {
